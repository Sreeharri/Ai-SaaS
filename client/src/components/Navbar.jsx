...
const Navbar = () => {
    ...
    return (
        <div className='fixed z-5 w-full backdrop-blur-2xl flex justify-between items-center py-3 px-4 sm:px-20 xl:px32 '>
            <img src={assets.logo} alt="logo" className='w-32 sm:w-44 cursor-pointer' onClick={() => navigate("/")} />

            {
                user ? < UserButton/> // If user is logged in, show UserButton
                : 
                (
