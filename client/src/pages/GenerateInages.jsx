  ...
  return (
    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4' >
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <textarea onChange={(e) => setInput(e.target.value)} value={input} rows={4}  className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border-gray-500' placeholder='Describe what your what to see in the image' required />
        ...
        <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
          ...
          <div className='my-6 flex items-center gap-2'>
              <label className='relatie cursor-pointer'>
