  ...
  return (
    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4' >
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <input onChange={(e) => setInput(e.target.files[0])}  type="file" accept='application/pdf' className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border-gray-500 text-gray-600'  required />
